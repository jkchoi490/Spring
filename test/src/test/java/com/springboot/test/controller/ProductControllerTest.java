...
@WebMvcTest(ProductController.class) //웹에서 사용되는 요청과 응답에 대한 테스트 수행, 대상 클래스만 로드하여 테스트 수행 @WebMvcTest(대상클래스.class)
class ProductControllerTest {
    ...
    @Test
    @DisplayName("MockMvc를 통한 Product 데이터 가져오기 테스트") //@DisplayName
